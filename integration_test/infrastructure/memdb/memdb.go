...
const (
	...
	IdempotencyRecordsTableName = "idempotency_records"
)
...
var DBConfig = &memdb.DBSchema{
	Tables: map[string]*memdb.TableSchema{
		AccountsTableName:           AccountSchema,
		IdempotencyRecordsTableName: IdempotencyRecordSchema,
	},
}
...
var IdempotencyRecordSchema = &memdb.TableSchema{
	Name: IdempotencyRecordsTableName,
	Indexes: map[string]*memdb.IndexSchema{
		"id": {
			Name:    "id",
			Unique:  true,
